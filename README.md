...
Enter your keys in the ⚙️ Settings panel within the app. Entered keys are used for the current session only and are **not persisted** to browser storage.
...
When present, the app auto-loads this value on startup.
